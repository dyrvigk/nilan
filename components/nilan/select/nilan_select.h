...
class NilanSelect : public select::Select, public Component, public SensorItem {
public:
  NilanSelect(uint16_t start_address, uint8_t offset, uint32_t bitmask, SensorValueType value_type, 
